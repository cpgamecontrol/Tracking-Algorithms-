    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            ...
            if left_shoulder and right_shoulder:
                ...
                # # Determine the swaying direction based on shoulder movement - only moves right while you are moving right
                # if prev_shoulder_x is not None:
                #     shoulder_x_diff = right_shoulder_x - prev_shoulder_x
